            ...
            <DrawerBody>
              <Stack spacing="24px">
                <Flex justifyContent={"space-between"}>                  
                  <Input id="title" placeholder="Things to do" width="60%" value={title}  onChange={(e) => setTitle(e.target.value)}/>
                  <Checkbox checked={highPriority} onChange={(e) => {sethighPriority(e.target.checked)}}>Priority</Checkbox>                
                </Flex>
                <Box>
                ...
                <Box w="60%" alignItems={"left"}>
                  <Flex  justifyContent={"space-between"} >
                    ...
                    <Input ml="50px" id="creator" placeholder="Add" width="80%" value={creator}
                ...
                <Box w="80%" >
                  <Flex  justifyContent={"space-between"}>
                    ...
                    <div className={styles.tagsbox}>                        
                      ...
                      <input onKeyDown={handleKeyDown} type="text" placeholder="+ Add more" className={styles.tagsinput}/>
                    </div>
                ...
                <Box w="60%">
                  <Flex justifyContent={"space-between"}>
                    ...
                    <Input ml={"65px"} type="date" id="deadline" width="80%" value={deadline}
                    ...
                    <AccordionPanel pb={4} >
                      ...
                      <Box w="60%" alignItems={"left"}>
                        <Flex ml="-1.5px" justifyContent={"space-between"}>
                          ...
                          <Input id="project" placeholder="Add" width="70%" value={project}
                      ...
                      <Box w="60%" alignItems={"left"}>
                        <Flex ml="-1.5px" justifyContent={"space-between"}>
                          ...
                          <Input type="time" id="time"  width="70%" value={time}
                      ...
                      <Box w="60%" alignItems={"left"}>
                        <Flex ml="-1.5px" justifyContent={"space-between"}>
                          ...
                          <Input id="tag" placeholder="Add" width="70%" value={tag} onChange={(e) => setTag(e.target.value)}/>
                        </Flex>
                      </Box>
                    </Stack>
                    </AccordionPanel>
